                                                                                    ...
                                                                                    foreach($data as $nr => $uuid){
                                                                                        ...
                                                                                        if(File::exist($url_ramdisk_record)){
                                                                                            ...
                                                                                            if ($count % 100 === 0) {
                                                                                                ...
                                                                                                echo 'count: ' . $count . '/', ($total * $options['page'] * $options['threads']) . ', percentage: ' . round(($count / ($total * $options['page'] * $options['threads'])) * 100, 2) . ', item per second: ' . $item_per_second . ', ' . File::size_format($size_format) . '/sec' . PHP_EOL;
                                                                                            }
                                                                                        }
                                                                                    }
                                                                                }
